...
- The diff introduces a new architectural pattern not present elsewhere in the repo → flag as a finding requiring human architect review before PR.
